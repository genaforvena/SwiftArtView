...
public class FavoriteButton: UIButton {
    ...
    private func addTargets() {
        ...
        // add target
        //===============
        self.addTarget(self, action: #selector(FavoriteButton.touchDown(_:)), forControlEvents: UIControlEvents.TouchDown)
        self.addTarget(self, action: #selector(FavoriteButton.touchUpInside(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        self.addTarget(self, action: #selector(FavoriteButton.touchDragExit(_:)), forControlEvents: UIControlEvents.TouchDragExit)
        self.addTarget(self, action: #selector(FavoriteButton.touchDragEnter(_:)), forControlEvents: UIControlEvents.TouchDragEnter)
        self.addTarget(self, action: #selector(FavoriteButton.touchCancel(_:)), forControlEvents: UIControlEvents.TouchCancel)
    }
    
    func touchDown(sender: FavoriteButton) {
        self.layer.opacity = 0.4
    }
    func touchUpInside(sender: FavoriteButton) {
        self.layer.opacity = 1.0
    }
    func touchDragExit(sender: FavoriteButton) {
        self.layer.opacity = 1.0
    }
    func touchDragEnter(sender: FavoriteButton) {
        self.layer.opacity = 0.4
    }
    func touchCancel(sender: FavoriteButton) {
        self.layer.opacity = 1.0
    }
